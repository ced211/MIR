...
if __name__ == "__main__":
    ...
    history = HistoryMem(filepath = "..\\models\\conv-spectrum-fq\\history-dropout40 ")
    ...
    model.fit_generator(train, epochs=30, verbose=1, validation_data=valid,callbacks=[checkpoint,history])
