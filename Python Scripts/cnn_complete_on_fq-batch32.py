...
from Mfcc_freq_seq_batch32 import FqMfccSeq32
import copy
from HistoryMem import HistoryMem

if __name__ == "__main__":

    history = HistoryMem(filepath = "..\\models\\conv-spectrum-fq\\history-batch32 ")
    train = FqMfccSeq32("..\\spectrum-train\\","..\\nsynth-train")
    valid = FqMfccSeq32("..\\spectrum-valid\\","..\\nsynth-valid")
    model = Sequential()
