...
if __name__ == "__main__":
    ...
    history = HistoryMem(filepath = "..\\models\\conv-spectrum-fq\\history-reg-dense ")
    ...
    model.compile(loss=keras.losses.categorical_crossentropy,
                ...
                metrics=['accuracy'])
    checkpoint = keras.callbacks.ModelCheckpoint("..\\models\\conv-spectrum-fq-reg-dense\\models-{epoch:02d}.hdf5", monitor='val_loss', verbose=0, save_best_only=False, save_weights_only=False, mode='auto', period=1)
